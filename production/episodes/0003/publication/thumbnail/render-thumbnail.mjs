...
const framePath = path.join(sourceDirectory, "episode-0003-presenter-420_000.png");
const blendedPath = path.join(sourceDirectory, "episode-0003-presenter-420_000-blended.png");
const editablePath = path.join(sourceDirectory, "episode-0003-thumbnail.svg");
const outputPath = path.join(here, "episode-0003-thumbnail.png");
...
await sharp(outputPath).resize(320, 180).png().toFile(path.join(previewDirectory, "episode-0003-thumbnail-320.png"));
await sharp(outputPath).resize(160, 90).png().toFile(path.join(previewDirectory, "episode-0003-thumbnail-160.png"));
const data = `data:image/png;base64,${(await fs.readFile(outputPath)).toString("base64")}`;
await sharp(Buffer.from(contactSheet(data)), { density: 144 }).resize(1600, 820).png().toFile(path.join(here, "episode-0003-thumbnail-contact-sheet.png"));
console.log(`Episode 0003 thumbnail: ${path.relative(repoRoot, outputPath)}`);
...
function foregroundSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" width="1280" height="720"><g transform="translate(64 75)"><text font-family="Inter,Arial,sans-serif" font-size="18" font-weight="750" fill="#f4f0e8" letter-spacing="5.2">ARTICULATE</text><text y="23" font-family="Inter,Arial,sans-serif" font-size="9" font-weight="650" fill="#6f95a5" letter-spacing="2.1">AI-NATIVE ARCHITECTURE JOURNAL</text></g><g transform="translate(1140 60)"><rect width="80" height="34" rx="17" fill="#172a34" stroke="#55798b"/><text x="40" y="22" text-anchor="middle" font-family="Inter,Arial,sans-serif" font-size="12" font-weight="750" fill="#f4f0e8" letter-spacing="1.4">EP 3</text></g><path d="M514 147H1190" stroke="#55798b" opacity=".42"/><g transform="translate(566 175)"><rect y="-19" width="96" height="6" rx="3" fill="#a65d3f"/><text y="34" font-family="Inter,Arial,sans-serif" font-size="14" font-weight="750" letter-spacing="2.4" fill="#8fa2aa">${config.episode.eyebrow}</text><text y="111" font-family="Inter,Arial,sans-serif" font-size="70" font-weight="800" letter-spacing="-2.2" fill="#f4f0e8">${config.episode.headline[0]}</text><text y="190" font-family="Inter,Arial,sans-serif" font-size="67" font-weight="800" letter-spacing="-2.1" fill="#c77a58">${config.episode.headline[1]}</text></g><g transform="translate(570 520)" font-family="Inter,Arial,sans-serif" font-size="11" font-weight="700" fill="#dbe8eb"><rect width="144" height="48" rx="10" fill="#142832" stroke="#55798b"/><text x="72" y="29" text-anchor="middle">ALTERNATIVE</text><path d="M154 24h34" stroke="#55798b" stroke-width="2"/><rect x="198" width="126" height="48" rx="10" fill="#142832" stroke="#55798b"/><text x="261" y="29" text-anchor="middle">PATTERN</text><path d="M334 24h34" stroke="#55798b" stroke-width="2"/><rect x="378" width="190" height="48" rx="10" fill="#18362f" stroke="#a65d3f"/><text x="473" y="29" text-anchor="middle">RESPONSIBILITY</text></g></svg>`;
}
function contactSheet(imageHref) { return `<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="820"><rect width="1600" height="820" fill="#081219"/><text x="48" y="55" font-family="Inter,Arial,sans-serif" font-size="27" font-weight="800" fill="#f4f0e8">EPISODE 0003 · THUMBNAIL REVIEW</text><text x="48" y="88" font-family="Inter,Arial,sans-serif" font-size="15" fill="#8fa2aa">Full composition · 25% scale · mobile scale</text><image href="${imageHref}" x="48" y="150" width="960" height="540"/><image href="${imageHref}" x="1060" y="150" width="320" height="180"/><image href="${imageHref}" x="1060" y="408" width="160" height="90"/><text x="48" y="742" font-family="Inter,Arial,sans-serif" font-size="14" fill="#8fa2aa">Presenter frame 420.000s · refreshed presenter soft blend · 56px safe margin</text></svg>`; }
